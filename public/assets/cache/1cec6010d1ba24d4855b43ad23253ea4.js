...
app.controller('Questions/ListCtrl', function($scope, CourseSelector, Question) {
...
app.controller('Questions/AddCtrl', function($scope, $routeParams, CourseSelector, Question) {
	$scope.questions = null;
	$scope.course = {};
