...
.directive('iframeResize', function(){
	return {
		link: function($scope, elem, attrs) {
			elem.load(function(){
				var that = this;
				console.log(that.contentWindow.document.body.scrollHeight);
				
			});

			$scope.$watch(function() {return elem.contentWindow.document.body.scrollHeight}, function(newHeight) {
