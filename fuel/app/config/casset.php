...
return array(
	...
	'paths' => array(
		'core' => 'assets/',
		'angular' => array(
			'path' => 'components/angular-1.0.5/',
			'js_dir' => ''
		),
		'angular-ui' => array(
			'path' => 'components/angular-ui-0.4.0/',
			'js_dir' => ''
		),
		'bootstrap' => 'components/bootstrap-2.3.1/',
		'file-uploader' => array(
			'path' => 'components/file-uploader-3.3/',
			'js_dir' => 'client/js/',
			'css_dir' => 'client/',
		),
		'imperico-theme' => array(
			'path' => 'components/imperico-theme/',
			'js_dir' => 'html/js/',
			'css_dir' => 'html/css/',
		),
		'jquery' => array(
			'path' => 'components/jquery-1.9.1/',
			'js_dir' => ''
		),
		'select2' => array(
			'path' => 'components/select2-3.2/',
			'js_dir' => '',
			'css_dir' => '',
		),
		'angular_lecturer_app' => array(
			'path' => 'lecturer/',
			'js_dir' => 'scripts/'
		),
		'angular_student_app' => array(
			'path' => 'student/',
			'js_dir' => 'scripts/'
		)
	),
	...
	'groups' => array(
		'js' => array(
			'jquery' => array(
				'files' => array(
					array('jquery::jquery.js', 'jquery::jquery.js')
				),
				'enabled' => true,
				'min' => true
			),
			'bootstrap' => array(
				'files' => array(
					array('bootstrap::bootstrap.js', 'bootstrap::bootstrap.min.js'),
				),
				'enabled' => true,
				'combine' => true,
			),
		...
		'css' => array(
			'bootstrap' => array(
				'files' => array(
					array('bootstrap::bootstrap.css', 'bootstrap::bootstrap.min.css'),
					array('bootstrap::bootstrap-responsive.css', 'bootstrap::bootstrap-responsive.min.css'),
				),
				'enabled' => true,
				'combine' => true,
			),
